...
void Boat()  //Tutul,Abdur Rahaman (19-40450-1)
{
    glPushMatrix();
...
void River()  //Tutul,Abdur Rahaman (19-40450-1)
    {
...
void House()//Tutul,Abdur Rahaman(19-40450-1)
    {
    glPushMatrix();
    glScalef(0.05,0.07,0.0);
    glPushMatrix();
    //house on left side//
//polygon 1
    glBegin(GL_POLYGON);// Draw a Red 1x1 Square centered at origin
    glColor3ub(139,69,19);
    glVertex2f(-12.7f,-0.8f);
    glVertex2f(-16.7f,-0.8f);
...
//polygon a
    ...
    glVertex2f(-12.5f,-3.2f);
    glVertex2f(-14.0f,-3.2f);
...
//polygon b
    glBegin(GL_POLYGON);// Draw a Red 1x1 Square centered at origin
    glColor3ub(128,135,32);
    glVertex2f(-13.3f,-5.0f);
    glVertex2f(-13.3f,-3.4f);
    glVertex2f(-14.0f,-3.2f);
    glVertex2f(-14.0f,-5.0f);
...
//polygon c
    ...
    glVertex2f(-12.5f,-5.0f);
    glVertex2f(-12.5f,-3.2f);
    glVertex2f(-13.2f,-3.4f);
    glVertex2f(-13.2f,-5.0f);
...
void tree()//Tutul,Abdur Rahaman(19-40450-1)
{
     glPushMatrix();
    glScalef(0.05,0.07,0.0);
    glPushMatrix();
...
//tree upper side//
    ...
    glPushMatrix();
    glColor3ub(0.0, 100.0, 0.0);
    glTranslatef(-20.5, 0.5, 0);
    ...
    glPushMatrix();
    glColor3ub(50,205,50);
    glTranslatef(-18.0, 2.0, 0);
    glutSolidSphere(1.0, 150, 150);
    glPopMatrix();

    glPushMatrix();
    glColor3ub(50,205,50);
    glTranslatef(-19.0, 3.0, 0);
    glutSolidSphere(1.0, 150, 150);
    glPopMatrix();
    ...
    void Tree()  //Tutul,Abdur Rahaman(19-39967-1)
{
//tree(small Tree)
    glPushMatrix();
...
void butterfly()   //Mariam Islam(18-38121-2)
{
...
void butterfly2()  //Mariam Islam(18-38121-2)
{
...
void plane()  //Mariam Islam(18-38121-2)
{
        glPushMatrix();
...
void trafficLight()    //Khan,Tahir azad(18-37901-2)
    {
...
void road()  //Khan,Tahir azad(18-37901-2)
{
...
void car()     //Khan,Tahir azad(18-37901-2)
{
glPushMatrix();
...
void Hills()                       //Nuzhut Tabassum (19-39967-1)
  //Hills.................................
      {
          glPushMatrix();
          glScalef(0.01,0.01,0.0);
...
void B_Railing()                     //Nuzhut Tabassum (19-39967-1)
     {
           glPushMatrix();
         glScalef(0.01,0.01,0.0);
    glPushMatrix();
    ...
    glPopMatrix();
     ...
     void Bridge()  //Nuzhut Tabassum (19-39967-1)
{
    glPushMatrix();
    glScalef(0.01,0.01,0.0);
    glPushMatrix();
...
void Train()  //Nuzhut Tabassum (19-39967-1)
{
...
void F_Railing()     //Nuzhut Tabassum (19-39967-1)
    {
         glPushMatrix();
         glScalef(0.01,0.01,0.0);
        glPushMatrix();
...
void Bird() //Nuzhut Tabassum (19-39967-1)
{
...
void Bird2()   //Nuzhut Tabassum (19-39967-1)
{
...
void Bird3()    //Nuzhut Tabassum (19-39967-1)
{
...
void snow(){  //Marina Afsana(18-38255-2)
 ...
 void windmill() {  //Marina Afsana(18-38255-2)
...
void wind2() {     //Marina Afsana(18-38255-2)
...
void moon()    //Mariam Islam(18-38121-2)
    {
         glPushMatrix();
glLineWidth(7.5);
